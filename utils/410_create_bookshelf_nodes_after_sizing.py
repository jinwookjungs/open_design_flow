...
def parse_cl():
    ...
    # Add arguments
    parser.add_argument(
            '--bs_nodes', action="store", dest='src_nodes', required=True)
    parser.add_argument(
            '--verilog', action="store", dest='src_v', required=True)
    parser.add_argument(
            '--lef', action="store", dest='src_lef', required=True)
    parser.add_argument(
            '-o', action="store", dest='dest_nodes', default='out.nodes')
